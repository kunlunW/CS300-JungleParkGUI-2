...
public class JungleParkTests extends JunglePark {
  ...
  public static boolean test2isCloseMethod() {
    ...
    if (d.isClose(t1, 100)) { // isClose() should return false here
      System.out.println("Deer's isClose is returning true when it should return false.");
      passed = false;
    }
  ...
  public static boolean test1DeerScanForThreatMethod() {
    ...
    Deer deer1 = new Deer(park); // creates an of instance of Deer type
    Tiger tiger1 = new Tiger(park);// creates an instance of Tiger type

    // Set deer at position(300,100)
    deer1.setPositionX(300);
    deer1.setPositionY(400);

    // Set first tiger at position(350,100)
    tiger1.setPositionX(350); // tiger is 50px away from deer in X-direction
    tiger1.setPositionY(400);

    if (!deer1.scanForThreat(100)) { // should return true here
  ...
  public static boolean test2DeerScanForThreatMethod() {
    ...
    Deer deer2 = new Deer(park); // creates an of instance of Deer type
    Tiger tiger2 = new Tiger(park);// creates an instance of Tiger type

    // Set deer at position(300,100)
    deer2.setPositionX(300);
    deer2.setPositionY(400);

    // Set first tiger at position(350,100)
    tiger2.setPositionX(500); // tiger is 50px away from deer in X-direction
    tiger2.setPositionY(400);

    if (deer2.scanForThreat(100)) { // should return false here
